...
public class Utility extends ManageBrowser {
    ...
    public List<WebElement> webElementList(String locator) {
...
//*************************** Select Class Methods ***************************************//
    ...
    public void selectByContainsTextFromDropDown(WebElement ele, String text) {
        List<WebElement> allOptions = new Select(ele).getOptions();
        for (WebElement options : allOptions) {
            if (options.getText().trim().equals(text)) {
                options.click();
                break;
            }
        }
...
//*************************** Action Methods ***************************************//
    ...
    public WebElement waitUntilVisibilityOfElement(WebElement ele, int time){
        WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(time));
    ...
    public WebElement waitForElementWithFluentWait(WebElement ele, int time, int pollingTime) {
        Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
                .withTimeout(Duration.ofSeconds(time))
                .pollingEvery(Duration.ofSeconds(pollingTime))
...
//***************************** Is Display Methods **********************************************//
    ...
    public void selectAutoPopulateFirstEntryByArrowKeysAndEnter(WebElement element) {
        waitForElementWithFluentWait(element,10,2).sendKeys(Keys.ARROW_DOWN);
        element.sendKeys(Keys.ENTER);
    }

    public WebElement findSingleElementByXpath(String xpathLocator){
        return driver.findElement(By.xpath(xpathLocator));
    }

    public void selectEntryByArrowKeysAndEnter(WebElement element, String str) {
        waitForElementWithFluentWait(element,10,2).sendKeys(str+Keys.TAB);
        //element.sendKeys(Keys.ENTER);
    }
